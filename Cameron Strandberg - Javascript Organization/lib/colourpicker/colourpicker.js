        ...
        miniColors: function(o, data) {
            ...
            var show = function(input) {
                ...
                selector
                    ...
                    .append('<div class="miniColors-hex"><span>HEX</span> <input type="text" class="color-hex" name="" size="7" value="#' + hsb2hex(hsb) + '" /></div>')
                    .css('display', 'none')
                ...
                // Update the main input when color is typed in
                var inputHex = selector.find('input.color-hex');
                inputHex.on('keyup.miniColors', function(event) {
                    input.val(inputHex.val());
                    setColorFromInput(input);
                });
            ...
            var setColor = function(input, hsb, updateInput) {
                ...
                if( updateInput ) {
                    var hexStr = '#' + convertCase(hex, input.data('letterCase'))

                    input.val(hexStr);
                    input.data('inputHex').val(hexStr);
                }
